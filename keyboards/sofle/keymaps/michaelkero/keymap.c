...
[_QWERTY] = LAYOUT(
    ...
    _______,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,KC_MUTE,_______,KC_N   ,KC_M   ,KC_COMM,KC_DOT ,KC_SLSH,_______,
...
[_ADJUST] = LAYOUT( 
    ...
    _______,RGB_TOG,RGB_RMOD,RGB_MOD,RGB_VAD,RGB_VAI,AU_ON  ,AU_OFF ,RGB_HUD,RGB_HUI,RGB_SAD,RGB_SAI,KC_F12 ,_______,
